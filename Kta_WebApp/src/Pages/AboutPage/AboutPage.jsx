    ...
    <>
      ...
      <div className={`${styles.Container} ${styles.HalfHalfSection}`}>
        <div className={styles.sectionDesc}>
          ...
          <div className={styles.OurStoryHeading}>
            India’s New Standard in Tile & Stone Solutions.
          </div>
          <div className={styles.OurStoryDesc}>
            KTA Solutions is a leading name in tile adhesives, stone care, and
            surface repair solutions across India. Engineered with cutting-edge
            technology and backed by deep industry expertise, our products are
            trusted by architects, contractors, and professionals nationwide.
            <br />
            <br />
            From ceramic tiles to complex restoration solutions, we bring
            together global innovation with local understanding to deliver
            materials that last—and results that impress.
            <br />
            <br />
            With a growing network of partners and applicators, we are committed
            to quality, sustainability, and shaping the future of surface
            solutions in India.
          </div>
        </div>
      ...
      <div className={`${styles.Vision} ${styles.HalfHalfSection}`}>
        <div className={styles.OurVisionBlock}>
          <div className={styles.OurVisionSmallBlock}>
            <div className={styles.OurVisionHeading}>
      ...
      <div className={styles.ValuesSection}>
        <div className={styles.HeadingSection}>
          <div className={styles.Heading}>
            Our <span className={styles.spanHeading}>Core</span> Values
          </div>
          <div className={styles.Desc}>
            At KTA Solutions, these four principles guide everything we create,
            build, and stand for
          </div>
        </div>
        <div className={` ${styles.HalfHalfSection}`}>
          <div className={styles.propDivForth}></div>
