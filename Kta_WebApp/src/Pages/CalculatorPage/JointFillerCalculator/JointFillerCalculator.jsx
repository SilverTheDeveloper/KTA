        ...
        <div className={styles.leftSection}>
          <div className={styles.firstBlock}>
            <p className={styles.fieldHeading}>Enter Area, Tile
              Width & Length</p>
            <div>
              <label className={styles.fieldSubHeading} for="total_Area">Total Tiled Area</label>
            ...
            <div>
              <label className={styles.fieldSubHeading} for="tile_Width">Tile Width</label>
              <div className={styles.InputDropdownBox}>
                <input
                  type="number"
                  id="block_Width"
            ...
            <div>
              <label className={styles.fieldSubHeading} for="tile_Length">Tile Length</label>
              <div className={styles.InputDropdownBox}>
                <input
                  type="number"
                  id="tile_Length"
          ...
          <div className={styles.secondBlock}>
            ...
            <div className={styles.secondBlockInnerDiv}>
              <div>
                <label className={styles.fieldSubHeading} for="joint_Width">Joint Width</label>
                <div className={styles.InputDropdownBox}>
                  <input
                    type="number"
                    id="joint_Width"
              ...
              <div>
                <label className={styles.fieldSubHeading} for="tile_Thickness">Tile Thickness / Joint Depth</label>
                <div className={styles.InputDropdownBox}>
                  <input
                    type="number"
                    id="tile_Thickness"
